    ...
    <Layout>
      <section className="container pt-40 pb-32">
        <div className="mb-24 px-4">
          ...
          <h1 className="font-display text-7xl md:text-9xl font-black text-white tracking-tighter leading-[0.8]">
            THE
            <br />
        ...
        <div className="flex flex-col gap-24 md:gap-40">
          {chapters.map((ch, i) => (
            ...
            >
              <div className="relative flex-1 w-full overflow-hidden rounded-[3rem] aspect-[4/3] md:aspect-auto md:h-[600px] shadow-2xl skew-y-1 group-hover:skew-y-0 transition-transform duration-1000">
                <img
                  src={ch.coverImage}
                  ...
                  alt={ch.name}
                />
                <div className="absolute inset-0 bg-primary/20 mix-blend-overlay opacity-40 group-hover:opacity-0 transition-opacity" />
              </div>
              ...
              <div className="flex-1 space-y-8 px-4">
                ...
                <h2 className="text-5xl md:text-7xl font-black tracking-tighter group-hover:text-primary transition-colors leading-none uppercase">
                  {ch.name}
                </h2>
                <p className="text-xl md:text-2xl text-white/40 font-light leading-relaxed max-w-md">
                  {ch.shortDescription}
                </p>
                <div className="pt-4">
                  <Button
